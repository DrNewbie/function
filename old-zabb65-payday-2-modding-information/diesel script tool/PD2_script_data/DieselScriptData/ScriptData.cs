namespace DieselScriptData
{
    ...
    public class DieselScriptData
    {
        ...
        public DieselScriptData(string path)
        {
            this.path =  path;
        ...
        private void table(ref Dictionary<string, object> data, List<string> path, ref BinaryWriter bw)
        {
            ...
            foreach (KeyValuePair<string, object> keypair in currentData)
            {
                if (!keypair.Key.Equals("_meta"))
                {
                    ...
                    if (keypair.Value is Dictionary<string, object>)
                    {
                        ...
                        table(ref data, currPath, ref bw);
